...
import animation.DesktopDinoAnimator
import animation.DesktopObstacleAnimator
import animation.DinoAnimator
import animation.ObstacleAnimator
import entity.GameState

@Composable
fun GameCanvasDesktop(
    state: GameState,
    onJump: () -> Unit,
    onRestart: () -> Unit,
    modifier: Modifier = Modifier
) {
    val dinoAnimator: DinoAnimator = remember { DesktopDinoAnimator() }
    val obstacleAnimator: ObstacleAnimator = remember { DesktopObstacleAnimator() }
